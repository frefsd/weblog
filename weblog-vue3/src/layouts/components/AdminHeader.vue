<template>
    <el-affix :offset="0">
        <div class="header flex text-light-50 top-0 right-0 left-0 items-center">
            ...
            <div class="ml-auto flex justify-center items-center">
                ...
                <el-dropdown class="dropdown flex justify-center items-center text-light-50 mx-5"
                    @command="handleCommand">
                    <span class="flex justify-center items-center">
                        <el-avatar :size="25" :src="$store.state.setting.avatar" class="mr-2" />
    ...
    <el-dialog v-model="dialogShow" title="修改密码" width="30%" :show-close="false">
        <el-form ref="formRef" :rules="rules" :model="form" autocomplete="new-password">
            <el-form-item label="用户名" prop="oldPassword" label-width="120px">
                <el-input v-model="form.username" disabled name="username-disabled" />
            </el-form-item>
            <el-form-item label="新密码" prop="newPassword" label-width="120px">
                <el-input v-model="form.newPassword" type="password" autocomplete="new-password"
                    name="new-password-field" placeholder="请输入新密码" show-password />
            </el-form-item>
            <el-form-item label="确认密码" prop="rePassword" label-width="120px">
                <el-input v-model="form.rePassword" type="password" autocomplete="new-password" name="re-password-field"
